...
@.str.46 = internal constant [10 x i8] c"Iteracion\00"
...
entry:
  ...
  %puts = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.46, i64 0, i64 0))
  %puts.1 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.46, i64 0, i64 0))
  %puts.2 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.46, i64 0, i64 0))
  %puts.3 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.46, i64 0, i64 0))
  %puts.4 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.46, i64 0, i64 0))
  ret i128 0
}
